...
class Login extends Component{
    ...
    async handleSubmit(e){
        e.preventDefault();
        let url = 'https://cors-anywhere.herokuapp.com/http://icc.ise.bgu.ac.il/njsw03users/forgotPassword';
        ...
        if(response.data.data === null){
            ...
            const response1 = await axios.get("https://cors-anywhere.herokuapp.com/http://icc.ise.bgu.ac.il/njsw03users/getVerificationQuestion?QuestionID=" + qID);
            this.setState({
                showID: false,
                showWrongUser: false,
                showQ: true,
    ...
    async handle(e){
        ...
        let url = 'https://cors-anywhere.herokuapp.com/http://icc.ise.bgu.ac.il/njsw03users/checkVerification';
        const response = await axios.post(
            url,
            {
                UserID: this.state.id,
    ...
    async changePass(event){
        ...
        if(this.state.pass !== this.state.pass2){
          ...
          var url = 'https://cors-anywhere.herokuapp.com/http://icc.ise.bgu.ac.il/njsw03users/passwordChangeCheck/changePassword';
          const response = await axios.post(
            url,
            {
    ...
    sumbit(e){
        e.preventDefault();
        axios.post('https://cors-anywhere.herokuapp.com/http://icc.ise.bgu.ac.il/njsw03users/login', {
            UserID: this.state.ID,
